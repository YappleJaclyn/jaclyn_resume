...
const FeatureList: EduFeature[] = [
    ...
    {
        title: 'Technical Intern at NASA S&K Research',
        src: require('/static/img/homepage/NASA_logo.svg.png').default,
        description: (
            <>
                <div className="col-demo">
                    <ul>
                        <li>Maintained the NASA RAP website using JavaScript, PHP and SQL</li>
                        ...
                        <li>Published hundreds of pages of technical documentation and several manuals that enabled over 3000 high schools to
                            complete robots</li>
